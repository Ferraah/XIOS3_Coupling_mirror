...
mpirun -np {{N}} ../oasis_ping_pong ocean_component {{GRID_NAME_SRC}} {{GRID_TYPE_SRC}} : -np {{M}} ../oasis_ping_pong atmos_component {{GRID_NAME_DST}} {{GRID_TYPE_DST}} > ../outputs/ocean_times_n{{N}}_m{{M}}.txt
...
#SBATCH --output=../oasis/results/out_n1_m1.txt
#SBATCH --error=../oasis/results/err_n1_m1.txt
#SBATCH --ntasks=2
...
echo "Running the ping-pong test with N=1 and M=1"
mpirun -np 1 ../oasis_ping_pong.exe ocean_component t12e LR false : -np 1 ../oasis_ping_pong.exe atmos_component icoh U false > ../outputs/ocean_times_n1_m1.txt
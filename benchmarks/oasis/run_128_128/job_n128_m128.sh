...
#SBATCH --output=../oasis/results/out_n128_m128.txt
#SBATCH --error=../oasis/results/err_n128_m128.txt
#SBATCH --ntasks=256
...
mpirun -np 128 ../oasis_ping_pong.exe ocean_component t12e LR false : -np 128 ../oasis_ping_pong.exe atmos_component icoh U false > ../outputs/ocean_times_n128_m128.txt
...
#SBATCH --output=../oasis/results/out_n256_m256.txt
#SBATCH --error=../oasis/results/err_n256_m256.txt
#SBATCH --ntasks=512
...
mpirun -np 256 ../oasis_ping_pong.exe ocean_component t12e LR false : -np 256 ../oasis_ping_pong.exe atmos_component icoh U false > ../outputs/ocean_times_n256_m256.txt
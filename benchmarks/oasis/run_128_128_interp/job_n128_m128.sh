...
#SBATCH --output=../oasis/results_interp/out_n128_m128.txt
#SBATCH --error=../oasis/results_interp/err_n128_m128.txt
#SBATCH --ntasks=256
...
rm -rf ../outputs_interp/ocean_times_n128_m128.txt

for i in $(seq 1 20); do

    rm -f rmp_*
    echo "Running interpolation iteration $i"
    mpirun -np 128 ../oasis_ping_pong.exe ocean_component t12e LR true : -np 128 ../oasis_ping_pong.exe atmos_component icoh U true >> ../outputs_interp/ocean_times_n128_m128.txt

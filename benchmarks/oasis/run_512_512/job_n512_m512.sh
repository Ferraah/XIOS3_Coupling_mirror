...
#SBATCH --output=../oasis/results/out_n512_m512.txt
#SBATCH --error=../oasis/results/err_n512_m512.txt
#SBATCH --ntasks=1024
...
mpirun -np 512 ../oasis_ping_pong.exe ocean_component t12e LR false : -np 512 ../oasis_ping_pong.exe atmos_component icoh U false > ../outputs/ocean_times_n512_m512.txt
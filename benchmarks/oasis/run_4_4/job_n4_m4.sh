...
#SBATCH --output=../oasis/results/out_n4_m4.txt
#SBATCH --error=../oasis/results/err_n4_m4.txt
#SBATCH --ntasks=8
...
mpirun -np 4 ../oasis_ping_pong.exe ocean_component t12e LR false : -np 4 ../oasis_ping_pong.exe atmos_component icoh U false > ../outputs/ocean_times_n4_m4.txt
...
#SBATCH --output=../oasis/results/out_n64_m64.txt
#SBATCH --error=../oasis/results/err_n64_m64.txt
#SBATCH --ntasks=128
...
mpirun -np 64 ../oasis_ping_pong.exe ocean_component t12e LR false : -np 64 ../oasis_ping_pong.exe atmos_component icoh U false > ../outputs/ocean_times_n64_m64.txt
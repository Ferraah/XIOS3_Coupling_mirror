...
#SBATCH --output=../oasis/results/out_n8_m8.txt
#SBATCH --error=../oasis/results/err_n8_m8.txt
#SBATCH --ntasks=16
...
mpirun -np 8 ../oasis_ping_pong.exe ocean_component t12e LR false : -np 8 ../oasis_ping_pong.exe atmos_component icoh U false > ../outputs/ocean_times_n8_m8.txt
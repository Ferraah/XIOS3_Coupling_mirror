...
trim_outliers = 0  # Percentage of outliers to trim
NM_LIST = [(n, n) for n in [32, 128, 256, 512]]  # Process counts for ping-pong tests
...
make_interpolation_plot(dfi, title_interp, save_path="benchmark_xios_interpolation.png")